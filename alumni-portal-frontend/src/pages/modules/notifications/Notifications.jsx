                ...
                <div className="req-user-info">
                  ...
                  <div className="req-details">
                    ...
                    <p className="req-role">
                      {requester?.role} • {isMentorship ? "applied for mentorship" : "wants to connect"}
                    </p>
                    ...
                    {isMentorship && studentProfile && (
                      <div className="student-details">
                        <div className="detail-row">
                          ...
                          <span className="detail-value">{studentProfile.degree || "N/A"}</span>
                        </div>
                        <div className="detail-row">
                          <span className="detail-label">Department:</span>
                          <span className="detail-value">{studentProfile.department || "N/A"}</span>
                        </div>
                        <div className="detail-row">
                          <span className="detail-label">Semester:</span>
                          <span className="detail-value">{studentProfile.semester || "N/A"}</span>
                        </div>
                        <div className="detail-row">
                          <span className="detail-label">CGPA:</span>
                          <span className="detail-value">{studentProfile.cgpa ? studentProfile.cgpa.toFixed(2) : "N/A"}</span>
                        </div>
